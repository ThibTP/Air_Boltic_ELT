I will not code the entire project (e.g airflow dags, dbt models) but I will cover how the project structure should look like with the relevant folders alongside the implementation of the data model. 
